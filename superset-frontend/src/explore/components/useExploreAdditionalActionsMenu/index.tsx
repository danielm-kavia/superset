...
import { resetExploreConfig } from 'src/explore/actions/exploreActions';

export const SEARCH_THRESHOLD = 10;

const MENU_KEYS = {
  EDIT_PROPERTIES: 'edit_properties',
  RESET_CHART_CONFIGURATION: 'reset_chart_configuration',
...
export const useExploreAdditionalActionsMenu = (
  ...
  const menu = useMemo(() => {
    ...
    menuItems.push({
      key: MENU_KEYS.RESET_CHART_CONFIGURATION,
      label: t('Reset chart configuration'),
      onClick: () => {
        dispatch(resetExploreConfig());
        setIsDropdownVisible(false);
      },
    });
